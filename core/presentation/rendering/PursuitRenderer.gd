...
## Binds Logical Drill State directly to GPU Shader parameters for Stream 2012.

const PURSUIT_SHADER = preload("res://core/presentation/rendering/shaders/pursuit.gdshader")
...
func _init() -> void:
	...
	_material.shader = PURSUIT_SHADER
...
func apply_state(model: Dictionary) -> void:
	...
	_material.set_shader_parameter("pursuit_variant", float(params.get("pursuit_variant", 0.0)))
