...
**Purpose:** semantic freeze record; for the organized repository and next-session continuity use `docs/master-prompts/MASTER_HANDOVER_C11_B_REPOSITORY_ORGANIZATION.md` after that checkpoint has been validated and committed.
...
3. Read `docs/01_ARCHITECTURE.md` and `docs/history/c11-freeze/13_ARCHITECTURE_MANIFESTO.md`.
