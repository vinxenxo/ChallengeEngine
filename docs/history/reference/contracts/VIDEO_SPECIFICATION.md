...
godot [renderer de producción] \
  --write-movie artifacts/production/challenges/CHALLENGE_XXX_raw.avi \
  --fixed-fps <fps> \
...
```bash
ffmpeg -y -i artifacts/production/challenges/CHALLENGE_XXX_raw.avi \
  -vf scale=1080:1920:flags=lanczos \
  -c:v libx264 \
  -crf 18 \
  -pix_fmt yuv420p \
  artifacts/production/challenges/CHALLENGE_XXX.mp4
```
...
```text
artifacts/production/challenges/CHALLENGE_XXX/CHALLENGE_XXX_raw.avi
artifacts/production/challenges/CHALLENGE_XXX/CHALLENGE_XXX.mp4
artifacts/production/challenges/CHALLENGE_XXX/CHALLENGE_XXX_manifest.json
artifacts/production/challenges/BATCH_MANIFEST.json
```
