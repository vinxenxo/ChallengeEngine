...
def run_factory(
    ...
    if not isinstance(audio_export_info, dict):
        ...
        return {
            ...
            "error": {
                ...
                "message": (
                    "[AUDIO_EXPORT_JSON] debe contener un objeto JSON."
                ),
            },
        }
    ...
    if "audio_enabled" not in audio_export_info:
        ...
        return {
            ...
            "error": {
                "code": "INVALID_AUDIO_EXPORT_JSON",
                "message": (
                    "[AUDIO_EXPORT_JSON] carece de la clave "
                    "audio_enabled."
                ),
            },
        }
    ...
    if type(audio_enabled_raw) is not bool:
        ...
        return {
            ...
            "error": {
                "code": "INVALID_AUDIO_EXPORT_JSON",
                "message": (
                    "audio_enabled debe ser booleano."
                ),
            },
        }
    ...
    if has_audio:
        if (
            not audio_pcm_path.is_file()
            or audio_pcm_path.stat().st_size <= 0
        ):
            cleanup_partial_outputs(
                output_dir,
                challenge_id
            ...
            return {
                ...
                "error": {
                    ...
                    "message": (
                        "Audio habilitado pero el archivo PCM "
                        "no existe o está vacío."
                    ),
                },
            }

        audio_hash = compute_file_sha256(
            audio_pcm_path
        )
        ...
        if not audio_hash:
            ...
            return {
                ...
                "error": {
                    ...
                    "message": (
                        "No se pudo calcular SHA-256 del "
                        "PCM canónico."
                    ),
                },
            }
