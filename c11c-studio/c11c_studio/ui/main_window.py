...
class MainWindow(QMainWindow):
 def __init__(self,ctx,cfg,app_version="0.3.0"):
 ...
 def _nav(self):
  r=QFrame();r.setObjectName("NavRail");r.setFixedWidth(238);v=QVBoxLayout(r);v.setContentsMargins(12,14,12,12);v.setSpacing(3)
  self.nav=[];idx=0
  groups=[("WORKFLOW",[("Dashboard",0),("Review Lab",1),("Production",2)]),("CREATIVE",[("Art Direction",3),("Families",4),("Seeds",5)]),("OUTPUT",[("Products",6),("Artifacts",7),("Jobs",8),("Logs",9)]),("SYSTEM",[("Validation",10),("Games / Drills",11),("Reproduction",12),("Settings",13),("About / Diagnostics",14)])]
  for heading,items in groups:
   ...
   if heading!="SYSTEM":v.addSpacing(10)
  v.addStretch(1)
  hint=QLabel("BACKEND IS SOURCE OF TRUTH\nGUI controls canonical tools") ;hint.setObjectName("NavHint");hint.setWordWrap(True);v.addWidget(hint)
