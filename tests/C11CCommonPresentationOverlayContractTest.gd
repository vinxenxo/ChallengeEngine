...
func _initialize() -> void:
    ...
    _assert(duration_source.find("return 20.0") >= 0 and duration_source.find("return 22.0") >= 0 and duration_source.find("return 23.0") >= 0, "Visual Loop duration policy must cover 20/22/23 seconds.")
