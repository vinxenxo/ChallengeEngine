...
try {
    ...
    $godotArgs=@('--path','.','--scene','tools/prototypes/c11c_living_particles_v1/LivingParticlesPrototype.tscn','--write-movie',$Avi,'--fixed-fps','30','--resolution','720','1280','--quit-after','540')
