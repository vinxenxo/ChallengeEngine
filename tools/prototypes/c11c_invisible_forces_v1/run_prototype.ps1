...
try {
    & godot --path . --scene tools/prototypes/c11c_invisible_forces_v1/InvisibleForcesPrototype.tscn --write-movie $Avi --fixed-fps 30 --quit-after 540 2>&1 | Tee-Object -FilePath $GodotLog
