...
try {
    ...
    $godotArgs=@('--path','.','--scene','tools/prototypes/c11c_geometric_waves_v1/GeometricWavesPrototype.tscn','--write-movie',$Avi,'--fixed-fps','30','--resolution',$DeliveryResolution,'--quit-after','540')
