...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        raise SystemExit("usage: generate_c11c_geometric_waves_v1_music.py OUTPUT.wav [SEED]")
    out = sys.argv[1]
    ...
    generate(out, seed, "geometric", loop_cycles, duration)
    print("[C11-C-AUDIO] GEOMETRIC WAVES ambient WAV generated: " + out)
