...
try {
    ...
    $godotArgs=@('--path','.','--scene','tools/prototypes/c11c_sacred_symmetry_v1/SacredSymmetryPrototype.tscn','--write-movie',$Avi,'--fixed-fps','30','--resolution',$DeliveryResolution,'--quit-after','540')
