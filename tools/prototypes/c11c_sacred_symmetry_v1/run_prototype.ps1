...
try {
    & godot --path . --scene tools/prototypes/c11c_sacred_symmetry_v1/SacredSymmetryPrototype.tscn --write-movie $Avi --fixed-fps 30 --resolution 720x1280 --quit-after 540 2>&1 | Tee-Object -FilePath $GodotLog
    ...
    if (-not $NoSound) {
        & python $AudioScript $Audio $Seed $loopCycles $DurationSeconds 'sacred_symmetry'
