...
try {
    ...
    $godotArgs=@('--path','.','--scene','tools/prototypes/c11c_fractal_bloom_v1/FractalBloomPrototype.tscn','--write-movie',$Avi,'--fixed-fps','30','--resolution','720','1280','--quit-after','540')
