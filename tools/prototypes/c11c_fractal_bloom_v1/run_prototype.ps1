...
$AudioScript = Join-Path $PSScriptRoot 'generate_c11c_fractal_bloom_v1_music.py'
...
try {
    & godot --path . --scene tools/prototypes/c11c_fractal_bloom_v1/FractalBloomPrototype.tscn --write-movie $Avi --fixed-fps 30 --quit-after 540 2>&1 | Tee-Object -FilePath $GodotLog
